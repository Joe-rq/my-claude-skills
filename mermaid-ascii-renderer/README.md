...
**beautiful-mermaid** 是一个将 Mermaid 图表转换为精美 ASCII/Unicode 渲染的开源项目，采用 [MIT 协议](https://github.com/lukilabs/beautiful-mermaid/blob/main/LICENSE) 开源。感谢该项目作者提供了优秀的实现，使我们能够深入理解其内部架构和算法。
